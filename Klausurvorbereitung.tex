...
\end{document}
=======
\section*{Ein Heerführer missachtet die Warnungen der Götter\footnote{Lektion 10, Seite 62f}}
\begin{Parallel}[v]{0.48\textwidth}{0.48\textwidth}
\ParallelPar
\ParallelLText{
Flaminus, quamquam consul alter cum altero exercitu iam in itinere erat, statim castra moveri, signa proferri, proelium committi iussit.
}
\ParallelRText{
Obwohl ein anderer Konsul mit einem zweiten Heer auf dem Weg war, befahl Flaminius, sich sofort aufzumachen, das Feldzeichen vorwärtszutragen [und] die Schlacht zu beginnen.
}
\ParallelPar
\ParallelLText{
Postquam nuntiatum est signa e terra convelli non posse, Flaminius clamavit: "Abite, stulti!
}
\ParallelRText{
Nachdem gemeldet worden war, dass das Feldzeichen nicht aus der Erde gezogen werden kann, rief Flaminius: "Geht fort, Narren!
}
\ParallelPar
\ParallelLText{
Effodite signa, si metus hostium manus vestras debilitat!"
}
\ParallelRText{
Grabt das Feldzeichen aus, wenn die Furcht vor den Feinden eure Hände lähmt!"
}
\ParallelPar
\ParallelLText{
Quod ubi factum est, milites, quamquam omen metuebant, iter in proelium fecerunt.
}
\ParallelRText{
Sobald dies gemacht worden war, marschierten die Soldaten in die Schlacht, obwohl die das böse Vorzeichen fürchten.
}
\ParallelPar
\ParallelLText{
Quo in proelio paene cuncti ab hostibus caesi sunt.
}
\ParallelRText{
Diese wurden fast alle in der Schlacht von den Feinden getötet.
}
\ParallelPar
\ParallelLText{
Flaminium consulem eques exercitu Hannibalis lancea cecedit.
}
\ParallelRText{
Ein Reiter aus dem Heer Hannibals tötete den Konsult Flaminius mit einer Lanze.
}
